...
// OUR MODIFIED FUNCTION VERIFYSEAL ML
func (ethash *Ethash) verifySealML(chain consensus.ChainHeaderReader, header *types.Header, fulldag bool, sel int) error {
	log.Info("VERIFY SEAL ...............................")
	if ethash.config.PowMode == ModeFake || ethash.config.PowMode == ModeFullFake {
